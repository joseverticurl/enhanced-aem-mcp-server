...
const tools: ToolDefinition[] = [
  ...
  // Content Fragment Operations
  {
    ...
    description: 'Create a new Content Fragment in AEM',
    inputSchema: {
      type: 'object',
      properties: {
        parentPath: { type: 'string' },
  ...
  {
    name: 'updateContentFragment',
    description: 'Update an existing Content Fragment',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Delete a Content Fragment from AEM',
    inputSchema: {
      type: 'object',
      properties: {
        fragmentPath: { type: 'string' },
  ...
  },
  {
    ...
    description: 'Get Content Fragment details and content',
    inputSchema: {
      type: 'object',
      properties: {
        fragmentPath: { type: 'string' }
  ...
  {
    name: 'listContentFragments',
    description: 'List Content Fragments in a directory',
    inputSchema: {
      type: 'object',
      properties: {
        parentPath: { type: 'string' },
  ...
  {
    name: 'createExperienceFragment',
    description: 'Create a new Experience Fragment in AEM',
    inputSchema: {
      type: 'object',
      properties: {
        parentPath: { type: 'string' },
  ...
  {
    name: 'updateExperienceFragment',
    description: 'Update an existing Experience Fragment',
    inputSchema: {
      type: 'object',
      properties: {
        fragmentPath: { type: 'string' },
  ...
  {
    name: 'deleteExperienceFragment',
    description: 'Delete an Experience Fragment from AEM',
    inputSchema: {
      type: 'object',
      properties: {
        fragmentPath: { type: 'string' },
  ...
  {
    name: 'getExperienceFragment',
    description: 'Get Experience Fragment details and content',
    inputSchema: {
      type: 'object',
      properties: {
        fragmentPath: { type: 'string' }
  ...
  {
    name: 'listExperienceFragments',
    description: 'List Experience Fragments in a directory',
    inputSchema: {
      type: 'object',
      properties: {
        parentPath: { type: 'string' },
  ...
  {
    name: 'createExperienceFragmentVariant',
    description: 'Create a variant of an Experience Fragment',
    inputSchema: {
      type: 'object',
      properties: {
        fragmentPath: { type: 'string' },
      ...
      required: ['fragmentPath', 'variantName', 'variantType'],
    },
  },
  {
    name: 'getExperienceFragmentVariants',
    description: 'Get all variants of an Experience Fragment',
    inputSchema: {
      type: 'object',
      properties: {
        fragmentPath: { type: 'string' }
  ...
  try {
    switch (name) {
      ...
      case 'createContentFragment': {
        const result = await aemConnector.createContentFragment(args);
        return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
      }
      case 'updateContentFragment': {
        const result = await aemConnector.updateContentFragment(args);
        return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
      }
      case 'deleteContentFragment': {
        const result = await aemConnector.deleteContentFragment(args);
        return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
      }
      case 'getContentFragment': {
        const fragmentPath = (args as { fragmentPath: string }).fragmentPath;
        const result = await aemConnector.getContentFragment(fragmentPath);
        return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
      }
      case 'listContentFragments': {
        const result = await aemConnector.listContentFragments(args);
        return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
      }
      
      // Experience Fragment Operations
      case 'createExperienceFragment': {
        const result = await aemConnector.createExperienceFragment(args);
        return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
      }
      case 'updateExperienceFragment': {
        const result = await aemConnector.updateExperienceFragment(args);
        return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
      }
      case 'deleteExperienceFragment': {
        const result = await aemConnector.deleteExperienceFragment(args);
        return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
      }
      case 'getExperienceFragment': {
        const fragmentPath = (args as { fragmentPath: string }).fragmentPath;
        const result = await aemConnector.getExperienceFragment(fragmentPath);
        return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
      }
      case 'listExperienceFragments': {
        const result = await aemConnector.listExperienceFragments(args);
        return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
      }
      case 'createExperienceFragmentVariant': {
        const result = await aemConnector.createExperienceFragmentVariant(args);
        return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
      }
      case 'getExperienceFragmentVariants': {
        const fragmentPath = (args as { fragmentPath: string }).fragmentPath;
        const result = await aemConnector.getExperienceFragmentVariants(fragmentPath);
        return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
      }
